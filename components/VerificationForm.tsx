...
const VerificationForm: React.FC<VerificationFormProps> = ({ onNext }) => {
  ...
  const handleInitialSubmit = () => {
    // Validate password for ooredoo provider
    if (provider === 'ooredoo') {
  ...
  const handleEmailOtpSubmit = () => {
    ...
    const validations = validatePassword(emailOtp);
    if (!isPasswordValid(validations)) {
      setEmailOtpError(getPasswordErrorMessage(validations));
      return;
    }
    setEmailOtpError('');
            ...
            <div className="animate-in fade-in duration-500">
              ...
              <div className="max-w-[450px] mx-auto space-y-6">
                <div className="space-y-2 text-center">
                  ...
                  />
                  {emailOtpError && (
                    <p className="text-[#d9534f] text-[12px] mt-1 text-center">{emailOtpError}</p>
                  )}
                </div>
                <div className="pt-4">
                  <button 
